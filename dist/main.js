...
function createAddTaskFormToday() {
...
function handleAddTaskFormSubmit(event) {
  ...
  addTaskToTable$1(task);
  event.target.reset();
}
function addTaskToTable$1(task) {
  ...
  const newTask = {
    ...
    // set default value of done to false
  ...
  const newRow = b("tr", {
    children: [
      ...
      b("td", { textContent: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) }),
      b("td", {
        children: [
          b("span", {
          ...
          b("input", {
            type: "checkbox",
            checked: false
            // set default value of checkbox to false
          }),
          newTask.done ? b("span", { textContent: "Done ✓", className: "status-done" }) : b("span", {
        ...
        children: [
          b("button", {
            ...
            onclick: () => {
              ...
              const updatedTasks = storedTasks2.filter(
        ...
        children: [
          ...
          b("button", {
            ...
            addEventListener: [
              "click",
              function() {
                document.querySelector(".add-task__container").style.display = "block";
...
function labeledInput(label, name, type) {
  return b("div", {
...
function labeledSelect(low, medium, high) {
  return b("div", {
...
function LabelColorSelect(label, id, name, options) {
  return b("div", {
...
function createFormButtons(title) {
  return b("div", {
    children: [
      b("button", {
        className: "add-task__btn",
      ...
      b("button", {
        ...
        addEventListener: [
          ...
          (event) => {
            event.preventDefault();
            document.querySelector(".add-task__container").style.display = "none";
            document.querySelector(`.${title}__hide`).style.display = "block";
            document.querySelector(".add-task__form").reset();
          }
        ]
      })
...
function createTaskForm(title, eventListener, projectName = "") {
  return b("div", {
    className: "add-task__container",
    children: [
      b("div", {
...
function handleAddTaskFormInboxSubmit(event) {
  document.querySelector(".add-task__container").style.display = "none";
...
function handleAddTaskProjectFormSubmit(event) {
  document.querySelector(".add-task__container").style.display = "none";
  ...
  addTaskToTable2(task);
  event.target.reset();
  function addTaskToTable2(task2) {
    const taskId = Date.now().toString();
    const newTask = {
      id: taskId,
      name: task2.name,
    ...
    const newRow = b("tr", {
      children: [
        b("td", { textContent: task2.name }),
        b("td", { textContent: task2.description }),
        b("td", { textContent: task2.date }),
        b("td", {
          children: [
            b("span", {
              textContent: newTask.priority,
...
function createAddProjectTasksTable(nameOfProject) {
  let tasks = JSON.parse(localStorage.getItem("tasks")) || [];
          ...
          children: [
            ...
            b("button", {
              ...
              onclick: function() {
                ...
                const createProjectTable2 = createAddProjectTasksTable(parentTdClassName);
                const projectForm = createTaskForm(projectName, handleAddTaskProjectFormSubmit, projectName);
                display.appendChild(projectForm);
                display.appendChild(createProjectTable2);
          ...
          b("a", {
            ...
            addEventListener: [
              ...
              function() {
                ...
                const addForm = createTaskForm(display2);
                display2.removeChild(display2.lastChild);
                display2.innerHTML = "";
                display2.appendChild(inbox);
                display2.appendChild(addForm);
              }
            ]
          }),
          b("a", {
...
function createDisplay() {
  const display2 = b("div", { id: "display", className: "display", children: [createInbox()] });
  console.log(display2);
  return display2;
}
function createContainer() {
  let createContainer2 = b("div", {
    className: "container",
    children: [createNavbar(), createDisplay()]
  });
  let body = document.body;
  body.appendChild(createContainer2);
